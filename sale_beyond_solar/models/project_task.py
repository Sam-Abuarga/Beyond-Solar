...
class ProjectTask(models.Model):
    ...
    has_inverter = fields.Boolean(string="Has Inverter", related='sale_order_id.has_battery')
    has_panel = fields.Boolean(string="Has Panel", related='sale_order_id.has_battery')
